    ...
    return (
        <div className="w-full flex justify-center items-center h-96">
            <div className="w-80 h-full bg-[#2ecc71] text-slate-800">
               ...
               <h2 className="text-center p-8 font-bold text-xl">
FOLLOW US
               </h2>
            ...
            <div className="w-96 h-full bg-slate-300">
             ...
             <textarea className="w-72 my-4 mx-6" name="" id="" cols="5" rows="5"></textarea>
          
             </div>
             <button className=" btn border-2 border-[#2ecc71] btn-outline mx-6 py-0.5 hover:bg-[#2ecc71] ">SUBMIT</button>
            </div>
