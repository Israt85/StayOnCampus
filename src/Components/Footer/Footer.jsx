...
export default function Footer5(i) {
    return (
        <footer className="flex flex-col text-white">
            ...
            <aside className="py-5 text-center text-sm text-white bg-[#5a4044]">
                <p>&copy; 2024 <a className=" text-xl">StayOn<span className="text-[#2ecc71]">Campus</span></a>. All Rights Reserved.</p>
            </aside>
        </footer>
    );
}
